...
public class MainActivity extends AppCompatActivity {
    ...
    // C (1) Create a field to store the weather display TextView
    TextView textView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // C (2) Use findViewById to get a reference to the weather display TextView
        textView = findViewById(R.id.tv_weather_data);

        // C (3) Create an array of Strings that contain fake weather data
        /*
