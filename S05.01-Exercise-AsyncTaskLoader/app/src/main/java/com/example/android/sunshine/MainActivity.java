...
public class MainActivity extends AppCompatActivity
    ...
    private void loadWeatherData() {
        ...
        Loader<String[]> loader = loaderManager.getLoader(LOADER_QUERY_WEATHER_DATA);
        if (loader == null) {
            loaderManager.initLoader(LOADER_QUERY_WEATHER_DATA, bundle, this);
        } else {
            loaderManager.restartLoader(LOADER_QUERY_WEATHER_DATA, bundle, this);
        }
    }
